...
public class Ataque {
    ...
    public Ataque(int id, String nombre, int nivelAprendizaje, int ppMax, int ppActual,
                  String tipo, Integer potencia, String tipoMovimiento, String estado,
                  Integer turnos, String mejora, Integer modificador) {
        this.id = id;
        this.nombre = nombre;
    ...
    public Integer getTurnos() { return turnos; }
