...
public class LoginController {
	...
	void comprobarLogin(ActionEvent event) {
		...
		if (usuario.isEmpty()) {
			int option = JOptionPane.showOptionDialog(null, "El nombre de usuario está vacío.", "Error de Login",
					JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] { "Reintentar" },
					"Reintentar");
		...
		if (pass.isEmpty()) {
			int option = JOptionPane.showOptionDialog(null, "La contraseña está vacía.", "Error de Login",
					JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] { "Reintentar" },
					"Reintentar");
			if (option == JOptionPane.CLOSED_OPTION) {
				return;
		...
		if (!EntrenadorDAO.existeEntrenador(conn, usuario)) {
			int option = JOptionPane.showOptionDialog(null,
					"El nombre de usuario no está registrado en la base de datos.", "Usuario no encontrado",
					JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] { "Reintentar" },
					"Reintentar");
			if (option == JOptionPane.CLOSED_OPTION) {
				return;
			...
			if (ent != null) {
				...
				int option = JOptionPane.showOptionDialog(null, "La contraseña es incorrecta.", "Contraseña incorrecta",
						JOptionPane.DEFAULT_OPTION, JOptionPane.ERROR_MESSAGE, null, new Object[] { "Reintentar" },
						"Reintentar");
				if (option == JOptionPane.CLOSED_OPTION) {
					return;
	...
	public void initialize() {
		...
		orden.add("./sonidos/El Canto del Loco - Zapatillas (Videoclip).mp3");
