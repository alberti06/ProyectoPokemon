...
public class TiendaController {
    ...
    private void comprar() {
        ...
        Map<Spinner<Integer>, String> nombres = Map.of(
            spinnerPila, "Pilas",
            spinnerEter, "Éter",
            spinnerPokeball, "Pokéball",
            spinnerBaston, "Bastón",
            spinnerChaleco, "Chaleco",
            spinnerPluma, "Pluma",
            spinnerPesa, "Pesa",
            spinnerAnillo, "Anillo"
        );
        ...
        for (Map.Entry<Spinner<Integer>, String> entry : nombres.entrySet()) {
            ...
            if (cantidad > 0) {
                ...
                System.out.println("Entrenador: " + entrenador.getUsuario() + " ha comprado " + cantidad + " unidades de " + nombreObjeto);
            }
        }
